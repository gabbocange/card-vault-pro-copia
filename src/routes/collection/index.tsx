// src/routes/index.tsx — FILE COMPLETO (con CurrencySwitcher nell'header)
  ...
  return (
    <AppShell>
      ...
      <div className="p-6 lg:p-8 space-y-8 min-h-screen">
        {/* Header con CurrencySwitcher e Add Card */}
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 glass-widget p-5 sm:p-6">
            <div className="flex items-center justify-between mb-4">
              <div><h2 className="text-sm font-semibold text-white">Portfolio Timeline</h2><p className="text-xs text-white/70 mt-0.5">Total value over time</p></div>
            </div>
            <CollectionTimeline />
          </div>
